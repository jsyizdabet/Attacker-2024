...
class Portfolio:
    ...
    def portfolio_performance(self):
        ...
        for index, row in self.stock_df.iterrows():
            if (row['weight'] == 0.00) or (row['weight'] == -0.00):
                performance_per_ticker.loc[len(performance_per_ticker)] = [row['ticker'], 0] 
    ...
    @property
    def stock_df_prop(self):
        return self.stock_df
    
    @property
    def transaction_list_prop(self):
